...
int abif_reg_indir_rd_modif_wr(u32 addr, u32 wr_data, u32 size_val, u32 shift_val, u32 post_wr_read, u32 tile_id)
{
    ...
    write32(LT_ABIF_CPLTL_OFFSET, addr | (tile_id << 30));
    if ( size_val != 32 ) {
        val = read32(LT_ABIF_CPLTL_DATA) & ~(((1 << size_val) - 1) << shift_val);
    }

    write32(LT_ABIF_CPLTL_DATA, val | (wr_data << shift_val));
    if (post_wr_read) {
        read32(LT_ABIF_CPLTL_DATA);
    }
    return result;
}
...
u32 abif_basic_read32(u32 offset)
{
    ...
    write32(LT_ABIF_CPLTL_OFFSET, offset);
    ret = read32(LT_ABIF_CPLTL_DATA);
...
{
    write32(LT_ABIF_CPLTL_OFFSET, offset);
    write32(LT_ABIF_CPLTL_DATA, val);
}
...
u32 abif_cpl_ct_read32(u32 offset)
{
    ...
    write32(LT_ABIF_CPLTL_OFFSET, offset);
    ret |= read32(LT_ABIF_CPLTL_DATA) & 0xFFFF;
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) + 2);
    ret |= read32(LT_ABIF_CPLTL_DATA) << 16;
...
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) | 0x01000000);
    return read32(LT_ABIF_CPLTL_DATA) & 0xFFFF;
}

u16 abif_cpl_tl_read16(u32 offset)
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) | 0x02000000);
    return read32(LT_ABIF_CPLTL_DATA) & 0xFFFF;
}

u16 abif_cpl_br_read16(u32 offset)
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) | 0x03000000);
    return read32(LT_ABIF_CPLTL_DATA) & 0xFFFF;
}

u16 abif_cpl_bl_read16(u32 offset)
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) | 0x04000000);
    return read32(LT_ABIF_CPLTL_DATA) & 0xFFFF;
}

u32 abif_gpu_read32(u32 offset)
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) | 0xC0000000);
    return read32(LT_ABIF_CPLTL_DATA);
}

void abif_cpl_ct_write32(u32 offset, u32 value32)
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF));
    write32(LT_ABIF_CPLTL_DATA, value32 & 0xFFFF);
    abif_force_data_read_cycle();
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) + 2);
    write32(LT_ABIF_CPLTL_DATA, value32>>16);
    abif_force_data_read_cycle();
}
...
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) | 0x01000000);
    write32(LT_ABIF_CPLTL_DATA, value16);
    abif_force_data_read_cycle();
}
...
{
    write32(LT_ABIF_CPLTL_OFFSET, (offset & 0xFFFF) | 0xC0000000);
    write32(LT_ABIF_CPLTL_DATA, value32);
    abif_force_data_read_cycle();
}
